...
class RawFile:
    ...
    def get_mass_list(self, scan_num, IntensityCutoffType = 0, IntensityCutoffValue = 0):
    ...
    def get_average_mass_list(self, start = 1, end = 1, IntensityCutoffType = 0, IntensityCutoffValue = 0):
    ...
    def find_peaks(self, data, cutoff = 100):
...
if __name__ == '__main__':
    ...
    for filename in Files:
        ...
        for j in range(scan_num):
            MassList = raw.get_mass_list(j+1,2,1)
